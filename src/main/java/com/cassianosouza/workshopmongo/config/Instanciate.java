package com.cassianosouza.workshopmongo.config;
...
import com.cassianosouza.workshopmongo.dto.AuthorDTO;
import com.cassianosouza.workshopmongo.dto.CommentDTO;
...
public class Instanciate implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/06/2018"), "Partiu viagem!", "Vou viajar para SP, abraços!",
				new AuthorDTO(maria));
